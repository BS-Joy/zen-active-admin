...
const WorkoutPlans = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            key: "workouts",
            dataIndex: "workouts",
            render: (workouts) => workouts?.slice(1, 3)?.map(workout => workout.name).join(", ") + '...' || "N/A",
        },
        {
            title: "Duration",
            key: "duration",
    ...
    const data = workoutPlans?.data?.map((workoutPlan, index) => ({
        key: index,
                ...
                <div className="rounded-lg border-2 py-4 border-[#174C6B]/80 mt-8 recent-users-table">
                    <div className="flex justify-between px-2">
                        ...
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <Input placeholder="Search plans by name" className="w-48 placeholder:text-[#174C6B]" style={{ border: '1px solid #79CDFF' }}
                                value={searchTerm || ''}
